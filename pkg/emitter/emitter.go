...
type MetricsSnapshot struct {
	...
	ResourceQuotaSpecCPURequests       []*source.ResourceQuotaSpecCPURequestResult
	ResourceQuotaSpecRAMRequests       []*source.ResourceQuotaSpecRAMRequestResult
	ResourceQuotaSpecCPULimits         []*source.ResourceQuotaSpecCPULimitResult
	ResourceQuotaSpecRAMLimits         []*source.ResourceQuotaSpecRAMLimitResult
	ResourceQuotaStatusUsedCPURequests []*source.ResourceQuotaStatusUsedCPURequestResult
	ResourceQuotaStatusUsedRAMRequests []*source.ResourceQuotaStatusUsedRAMRequestResult
	ResourceQuotaStatusUsedCPULimits   []*source.ResourceQuotaStatusUsedCPULimitResult
	ResourceQuotaStatusUsedRAMLimits   []*source.ResourceQuotaStatusUsedRAMLimitResult
}
