...
ENV TZ=UTC
 ...
 ADD ./ibm-finops-agent/configs/default.json /var/configs/models/default.json
 ADD ./ibm-finops-agent/configs/azure.json /var/configs/models/azure.json
 ADD ./ibm-finops-agent/configs/aws.json /var/configs/models/aws.json
 ADD ./ibm-finops-agent/configs/gcp.json /var/configs/models/gcp.json
